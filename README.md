...
The T1135 form is a requirement from the Canada Revenue Agency (CRA) for Canadian residents who own specified foreign property with a total cost of more than CAD $100,000 at any time during the tax year.

### What is Specified Foreign Property?
Specified foreign property includes:
- **Shares of non-resident corporations** (e.g., US stocks like AAPL, GOOGL) - these are foreign property regardless of where you hold them
- **Property held outside Canada** - including Canadian stocks held at a foreign broker

Property held in registered accounts (RRSP, TFSA, RRIF, RESP) is **exempt** from T1135 reporting.

### When is T1135 Required?
You must file a T1135 if:
- You are a Canadian resident for tax purposes
- You owned specified foreign property with a total cost exceeding CAD $100,000 at any time during the year
- The securities are held in a non-registered account
...
- **Foreign securities (USD stocks)**: Always counted toward T1135
- **Canadian securities (CAD stocks)**: Not counted (not foreign property)

If your account is at a **foreign broker** (e.g., a US brokerage), use `--foreign-broker`:
- **All securities**: Counted toward T1135 (held outside Canada)

This command will:
- Calculate the maximum cost of your specified foreign property during the tax year
- Show the maximum cost in CAD using official Bank of Canada exchange rates
- Break down the costs by individual security (marking foreign vs CAD)
